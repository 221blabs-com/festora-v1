...
export default function LoginPage() {
  ...
  if (user) {
    return (
      <div className="min-h-screen bg-[var(--bg)] flex items-center justify-center font-[family-name:var(--font-josefin)] text-center">
        <div>
          <Spinner />
          <p className="uppercase tracking-widest text-sm font-bold mt-4">
            Redirecting...
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-block mb-4">
             <div className="w-16 h-16 rounded-full border border-[var(--primary)] flex items-center justify-center mx-auto bg-[var(--bg)] shadow-[0_0_15px_var(--primary-glow)]">
                <span className="text-[var(--primary)] font-[family-name:var(--font-marcellus)] text-3xl font-bold">E</span>
             </div>
          </Link>
          <h1 className="text-3xl font-bold font-[family-name:var(--font-marcellus)] uppercase tracking-wide mb-2">Welcome Back</h1>
          <p className="text-[var(--fg-muted)]">Sign in to access your Festora dashboard</p>
        </div>
        ...
        <div className="bg-[var(--bg-card)] border border-[var(--border-subtle)] p-8 relative shadow-2xl corner-bracket">
          ...
          <div className="space-y-4">
               ...
               >
                  ...
                  <span>{githubComingSoon ? 'Coming Soon' : 'Continue with GitHub'}</span>
               </button>
          </div>
           ...
           <div className="mt-8 pt-6 border-t border-[var(--border-subtle)] text-center">
              <p className="text-[var(--fg-muted)] text-sm">
                 ...
                 <Link href="/signup" className="text-[var(--primary)] font-bold hover:text-[var(--primary-light)] underline decoration-[var(--primary)]/30 underline-offset-4 transition-all">
                    Sign up
                 </Link>
              </p>
           </div>
